...
Welcome to the most simple, lightweight yet effective spam comment blocker for Wordpress.

Features:

* Dead simple: no setup required, just activate it and enjoy your spam-free website.
* Lightweight: it makes no query to the DB, it does not add script files or other assets in your theme. This means your website performance will not be affected and your server will thank you.
