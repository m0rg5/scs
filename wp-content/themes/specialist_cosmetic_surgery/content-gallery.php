...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="entry-content">
		<?php if ( post_password_required() ) : ?>
			<?php the_content( __( 'Continue reading <span class="meta-nav">&rarr;</span>', 'squeeze' ) ); ?>
			...
			<?php else : ?>
				...
				<p><em><?php printf( _n( 'This gallery contains <a %1$s>%2$s photo</a>.', 'This gallery contains <a %1$s>%2$s photos</a>.', $total_images, 'squeeze' ),
						'href="' . get_permalink() . '" title="' . sprintf( esc_attr__( 'Permalink to %s', 'squeeze' ), the_title_attribute( 'echo=0' ) ) . '" rel="bookmark"',
	...
	<footer class="entry-meta">
		<?php if ( 'post' == get_post_type() ) : // Hide category and tag text for pages on Search ?>
			...
			<span class="cat-links">
				<?php printf( __( 'Posted in %1$s', 'scs' ), $categories_list ); ?>
			</span>
			<span class="sep"> | </span>
			...
			<span class="tag-links">
				<?php printf( __( 'Tagged %1$s', 'scs' ), $tags_list ); ?>
			</span>
			<span class="sep"> | </span>
