...
<script>// https://developers.google.com/youtube/iframe_api_reference
			...
			$video_url=get_post_meta($post->ID,'video_url',TRUE);
			   ...
			   ?>
				...
				<?php if(trim($video_url)) { ?>
				    <iframe id="video" width="100%" height="320" src="<?php echo $video_url; ?>?enablejsapi=1&html5=1" frameborder="0" allowfullscreen></iframe>
				<?php } else { ?>
