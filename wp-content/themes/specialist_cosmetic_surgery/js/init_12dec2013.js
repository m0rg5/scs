...
/*else if((awindow_widths > 640)) {

jQuery('#secondary-right aside .textwidget').removeClass('textwidget');	
jQuery('#colophon .footer-top-wrapper .testtextwidget').removeClass('testtextwidget');
//$(this).on( event );
